...
- Generated (UTC): `20260510T122146Z`
...
- V3.1 DA mode: `dann` | domain warmup epochs: `0` | domain ramp epochs: `0`
...
| 1 | 2 | -inf | 0.75 | 0.7 | False | True | 310,417 | 21 | 0.75 | 0.6364 | 0.7647 | 0.619 | 0.6442 | 0.7778 | 0.5385 | 1.0 | 1.0 | 1.0 | 0.2467 | 0.75 | 0.7647 | 1.0 | 0.5859 | 0.7857 | 0.7857 | 0.6753 | 0.7097 | 0.88 | 0.5 | 0.4048 |
...
| 3 | 0 | -inf | 0.875 | 0.7 | False | True | 349,439 | 10 | 0.875 | 0.6667 | 0.75 | 0.6 | 0.6667 | 0.5 | 1.0 | 1.0 | 0.6667 | 1.0 | 1.3809 | 0.875 | 0.75 | 1.0 | 0.5882 | 0.7719 | 0.7857 | 0.6459 | 0.6875 | 0.88 | 0.55 | 0.4048 |
| 4 | 0 | -inf | 1.0 | 0.7 | False | True | 421,428 | 13 | 1.0 | 0.7778 | 0.9565 | 0.6923 | 0.8182 | 1.0 | 0.6364 | 1.0 | 1.0 | 1.0 | 0.293 | 1.0 | 0.9524 | 1.0 | 0.5859 | 0.7719 | 0.7857 | 0.6459 | 0.6875 | 0.88 | 0.6 | 0.4048 |
...
| 11 | 0 | -inf | 0.96 | 0.7 | False | True | 354,405 | 15 | 0.96 | 0.8333 | 0.9474 | 0.7333 | 0.6 | 0.7143 | 1.0 | 1.0 | 0.6667 | 1.0 | 0.3368 | 0.96 | 0.9091 | 1.0 | 0.5882 | 0.7586 | 0.7857 | 0.6165 | 0.6667 | 0.88 | 0.6 | 0.4048 |
| 12 | 1 | -inf | 0.675 | 0.7 | False | True | 425,426 | 14 | 0.675 | 0.7059 | 0.8333 | 0.6429 | 0.675 | 0.8571 | 0.6 | 1.0 | 1.0 | 1.0 | 0.3482 | 0.675 | 0.8333 | 1.0 | 0.5859 | 0.7719 | 0.7719 | 0.6459 | 0.6875 | 0.88 | 0.5 | 0.4048 |
| 13 | 1 | -inf | 0.9667 | 0.7 | False | True | 355,446 | 11 | 0.9667 | 0.625 | 0.8333 | 0.4545 | 0.5 | 0.4545 | 1.0 | 1.0 | 0.6667 | 1.0 | 1.3249 | 0.9667 | 0.8333 | 1.0 | 0.5906 | 0.7719 | 0.7857 | 0.6459 | 0.6875 | 0.88 | 0.55 | 0.4048 |
...
| 403 | 11 | 1.0 | 0.5288 | 11 | 1 |
| 404 | 10 | 0.0 | 0.5782 | 0 | 0 |
| 408 | 6 | 0.0 | 0.4552 | 0 | 0 |
...
| validation_calibrated_prob | 0.2067 | 0.5881 | 0.0893 |
| final_test_raw_prob | 0.2647 | 0.728 | 0.1435 |
...
- `split_json`: `/scratch/shiv136/project_data/runs/holstein_task1_dann_v31_run_sbatch/dann_splits.json`
- `summary_json`: `/scratch/shiv136/project_data/runs/holstein_task1_dann_v31_run_sbatch/dann_summary.json`
- `fold_summary_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_dann_v31_run_sbatch/dann_fold_summary.csv`
- `val_predictions_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_dann_v31_run_sbatch/dann_predictions.csv`
- `test_predictions_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_dann_v31_run_sbatch/dann_test_predictions.csv`
- `test_cow_aggregates_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_dann_v31_run_sbatch/dann_test_cow_aggregates.csv`
- `test_calibrated_cow_aggregates_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_dann_v31_run_sbatch/dann_test_calibrated_cow_aggregates.csv`
- `diagnostics_json`: `/scratch/shiv136/project_data/runs/holstein_task1_dann_v31_run_sbatch/dann_diagnostics.json`
