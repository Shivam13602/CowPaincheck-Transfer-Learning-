...
- Generated (UTC): `20260510T145200Z`
...
- `split_json`: `/scratch/shiv136/project_data/runs/holstein_task1_weak_gce_v31_run_sbatch/weak_label_cv_splits.json`
- `summary_json`: `/scratch/shiv136/project_data/runs/holstein_task1_weak_gce_v31_run_sbatch/weak_label_cv_summary.json`
- `fold_summary_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_weak_gce_v31_run_sbatch/weak_label_cv_fold_summary.csv`
- `val_predictions_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_weak_gce_v31_run_sbatch/weak_label_cv_predictions.csv`
- `test_predictions_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_weak_gce_v31_run_sbatch/weak_label_cv_test_predictions.csv`
- `test_cow_aggregates_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_weak_gce_v31_run_sbatch/weak_label_cv_test_cow_aggregates.csv`
- `test_calibrated_cow_aggregates_csv`: `/scratch/shiv136/project_data/runs/holstein_task1_weak_gce_v31_run_sbatch/weak_label_cv_test_calibrated_cow_aggregates.csv`
- `diagnostics_json`: `/scratch/shiv136/project_data/runs/holstein_task1_weak_gce_v31_run_sbatch/weak_label_cv_diagnostics.json`
