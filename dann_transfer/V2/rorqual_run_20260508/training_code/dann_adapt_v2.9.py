...
def _load_weak_module() -> Any:
    return _load_module(HERE / "weak_label_adapt_v2.9.py", "weak_label_adapt_v2_9")
...
def _dann_finalize_outputs(
    *,
    ...
    threshold_values = [
        s["val_metrics"].get("best_threshold") for s in fold_summaries if s["val_metrics"].get("best_threshold") is not None
    ]
