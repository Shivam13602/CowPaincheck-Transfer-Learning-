...
The checkpoint folder for this Colab run is `v2.9_20260221_014705`. The saved benchmark JSONs in this workspace are still useful for sanity checks, but point your `--checkpoint_dir` at the `014705` checkpoint folder.
